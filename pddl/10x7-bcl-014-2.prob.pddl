; generated by prob2pddl.py problem-10x7-bcl-014-2.prob
; ##########
; #L      L#
; #O      O#
; ##      ##
...
; n 2
; 
; This one has a moving lift block; the initial wall block oscillates left/right
; This is Blockbusterz "Big Classic" pack number 14; 2 move limit
; O:2 L:2 blocks:4 spaces:26
(define (problem problem-10x7-bcl-014-2)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_9_5 orange)
        (patterned loc_2_6 lightblue)
        (patterned loc_9_6 lightblue)
    )
