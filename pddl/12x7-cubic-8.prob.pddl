; generated by prob2pddl.py problem-12x7-cubic-8.prob
; ################
; #ROYG          #
; #############  #
; #              #
...
; ################
; 
; Figure 1 from Cubic paper https://sections.maa.org/florida/proceedings/2001/friedman.pdf, 8 instead of 10 blocks, stretched just a little bit wide.
; R:2 O:2 Y:2 G:2 blocks:8 spaces:38
(define (problem problem-12x7-cubic-8)
(:domain puzznic)
    ...
    (:init
        ...
        (next loc_15_4 loc_15_5 up)
        (next loc_14_5 loc_15_5 right)
        (next loc_14_5 loc_14_6 up)
        (next loc_14_5 loc_14_4 down)
        (next loc_15_5 loc_14_5 left)
        (next loc_15_5 loc_15_6 up)
        (next loc_15_5 loc_15_4 down)
        ...
        (next loc_15_6 loc_15_5 down)
        (patterned loc_12_2 red)
        (patterned loc_13_2 orange)
        (patterned loc_14_2 yellow)
        (patterned loc_15_2 green)
