; generated by prob2pddl.py problem-9x7-cubic-6.prob
; #########
; #ROY    #
; ######  #
; #       #
...
; n 78
; 
; Figure 1 from Cubic paper https://sections.maa.org/florida/proceedings/2001/friedman.pdf, 6 instead of 10 blocks.
; R:2 O:2 Y:2 blocks:6 spaces:19
(define (problem problem-9x7-cubic-6)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_7_2 orange)
        (patterned loc_8_2 yellow)
