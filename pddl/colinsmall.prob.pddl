; generated by prob2pddl.py problem-colinsmall.prob
; ######
; #  R #
; #  # #
; #  G #
...
; ######
; 
; small version of colin.prob
; 
; Y:4 G:3 B:3 R:2 blocks:12 spaces:19
(define (problem problem-colinsmall)
(:domain puzznic)
